...
static Image images[NUM_IMAGES_TO_PACK] = {
    ...
    (Image) { TEX_CUTSCENE_1, "assets/textures/start-cutscene-1.png"},
    (Image) { TEX_CUTSCENE_2, "assets/textures/start-cutscene-2.png"},
...
void texture_init(void)
{
    ...
    glBufferData(GL_SHADER_STORAGE_BUFFER, textures_size, textures, GL_STATIC_DRAW);
    glBindBufferBase(GL_SHADER_STORAGE_BUFFER, SSBO_TEXTURE, ctx.tex_ssbo);
...
void texture_destroy(void)
{
    ...
    glDeleteBuffers(1, &ctx.tex_ssbo);
}
